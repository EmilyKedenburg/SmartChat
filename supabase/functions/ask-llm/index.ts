...
import { GoogleGenerativeAI } from "npm:@google/generative-ai"; // Updated import to use latest version
...
serve(async (req) => {
  ...
  try {
    ...
    const model = genAI.getGenerativeModel({ model: "gemini-1.5-flash" }); // Set model to gemini-1.5-flash
