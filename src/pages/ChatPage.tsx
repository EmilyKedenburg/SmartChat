      ...
      <Card className="w-full max-w-2xl bg-white dark:bg-gray-800 shadow-lg rounded-lg flex flex-col h-[90vh]">
        ...
        <CardContent className="flex-grow flex flex-col p-0">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 border-t dark:border-gray-700">
            ...
            <Button
              type="submit"
              className="w-full py-3 text-lg font-semibold text-foreground" // Added text-foreground class
              style={{ backgroundColor: primaryAccentColor }} // Removed inline color style
              disabled={isLoadingResponse}
            >
              {isLoadingResponse ? (
                <>
